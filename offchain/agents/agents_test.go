...
func loadTestConfig() (*AgentsConfig, error) {
	...
	return &AgentsConfig{
		...
		DeFi:  AgentRuntimeConfig{Port: 9101, Endpoint: "http://localhost:9101"},
		Data:  AgentRuntimeConfig{Port: 9102, Endpoint: "http://localhost:9102"},
		Trans: AgentRuntimeConfig{Port: 9103, Endpoint: "http://localhost:9103"},
